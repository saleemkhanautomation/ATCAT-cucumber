Feature: Recon Group
 ...
 Scenario: Create Recon Group
   ...
   Then select the value " ZQWXL" from the dropdown "ReconGroupID1"
   Then select the value " 9005" from the dropdown "ReconGroupID2"
   Then select the value " 620600" from the dropdown "ReconGroupID3"
   Then select the value " XZWYR" from the dropdown "ReconGroupID4"
 ...
 #Scenario: Upload GL and Bank Statement
  ...
  Scenario: Search the Recon Group
   Then I type at "ReconGroupSearch" value "ZQWXL-9005-620600-XZWYR"
   # Here the recon Group name is given directly in the above line
   Then I verify whether the value "ZQWXL-9005-620600-XZWYR" is present in the "ReconGroupValueAfterSearch"
