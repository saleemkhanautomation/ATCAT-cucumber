...
Feature: Carry Forward
  ...
  Scenario: Checking if carry forward is working
   ...
   And I wait for "15000" seconds 
    Then select the value "06-2020" from the dropdown "AccountingPeriods"
    And I wait for "10000" seconds
    Then I enter value "390040-9999" in "SearchBox" field
    And I wait for "10000" seconds
    Then Navigate to "SentForReviewTabDashboard"
    And I wait for "10000" seconds
    Then I check "390040-9999" is present or not
    And I wait for "10000" seconds
    Then select the value "07-2020" from the dropdown "AccountingPeriods"
    And I wait for "10000" seconds
    ...
    And I wait for "10000" seconds
    And I wait for "10000" seconds
    Then I verify All Items Counts contain "44" items
