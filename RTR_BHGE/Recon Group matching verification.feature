Feature: Recon Group matching verification
 ...
 Scenario: Checking if all the fields are present in Recon Group Matching
    ...
    Then  I enter value "XMR9H-7250-102101-XUSAN" in "SearchBox" field
    ...
    And I wait for "3000" seconds
    Then  I enter value "10,302.60" in "Searchboxfilter" field
    ...
    And I wait for "3000" seconds
    Then  I enter value "10,302.60" in "Searchboxfilterright" field
    # Enter the line item's Amount value for which Match has to be performed
    And I wait for "2000" seconds
    ...
    And I wait for "2000" seconds
 		Then I verify if "XMR9H-7250-102101-XUSAN" is present in Sent for review
 		And I wait for "2000" seconds
