...
Scenario: Create Recon type
   Given Open browser in incognito and navigate to "https://reconadvisor3-test.accenture.com/sit/"
    ...
    And I wait for "3000" seconds
    Then I type at "Name1path" value "RGT201234578"
    ...
    Then select the value "GLexample123" from the dropdown "DataSet1Dropdown"
    And I wait for "2000" seconds
    Then select the value "BSTexample123" from the dropdown "DataSet2Dropdown"
    ...
    Then I verify whether the value "RGT201234578" is present in the "ReconGroupTypeLocation"
   ...
   Scenario: Configure the workflow of the Recon Group type
    ...
    Then I will select " Matching" from Action dropdown
		Then I will select " GLexample123" from LeftDataSet dropdown
 		#Then I will select "example" from LeftRecords dropdown
 		Then I will select " BSTexample123" from RightDataSet dropdown
